...
@pytest.mark.todo
@pytest.mark.quick
def test_allocate_auto_and_parallel(params_and_trainer):
    # cases in which both auto and parallel balance are required
    pass


@pytest.mark.todo
@pytest.mark.ddp
def test_allocate_ddp(params_and_trainer):
    # cases in which both auto and parallel balance are required
    pass
